...
assert.ok(toolbarIndex >= 0 && toastIndex > toolbarIndex && mainIndex > toastIndex && footerIndex > mainIndex,
...
assert.ok(!css.includes('background: #62ddd2'), 'Legacy high-intensity highlight fill must not return in Studio embed.');

console.log('LRC Maker 6.3.7 Studio embed UX guard passed: confirmations stay in-flow and line states use readable Studio teal/cyan styling.');
